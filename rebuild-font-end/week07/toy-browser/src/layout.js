...
function layout(element) {
    ...
    // 设置flexDirection、alignItems、alignItems、flexWrap、alignContent默认值
    ...
    // mainBase标示起始位置，mainSign标示方向，从左往右为+，从右往左为-
    ...
    if (mainSpace < 0) {
        // overflow(happens only if container is single line),
    ...
    if (!style[crossSize]) { // aoto sizing
        crossSpace = 0;
